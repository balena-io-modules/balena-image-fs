...
* Update dependency flowzonify to v0.4.4 [balena-renovate[bot]]

## 7.6.19 - 2026-06-24

* Update to typescript v6 [joshbwlng]

## 7.6.18 - 2026-06-24

* Pin dependency tmp to 0.2.7 [balena-renovate[bot]]
...
* Add `explorePartition` function for exploring partitions of an image [Matthew Yarmolinsky]
